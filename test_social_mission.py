...
""", (
    ...
    agent_id,
    "Planejamento semanal Instagram - Biomecânica do Movimento",
    "Criar planejamento completo de 5 posts para Instagram do Vinicius Moraes sobre biomecânica, movimento humano e performance física.",
    "social",
    "approved",
    5,
...
print("Aguarde o worker processar (atualize a página de missões em 30-60 segundos)")
