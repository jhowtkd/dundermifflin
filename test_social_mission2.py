...
""", (
    ...
    agent_id,
    "Planejamento Instagram - Biomecânica e Performance",
    "Criar planejamento de 5 posts para Instagram sobre biomecânica do movimento, lesões esportivas e performance física.",
    "social",
    "approved",
    5,
...
print("Aguarde o worker processar...")
